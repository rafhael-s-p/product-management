...
//        Product p6 = pm.createProduct(104, "Chocolate", BigDecimal.valueOf(1.99), Rating.FIVE_STAR);
//        Product p7 = pm.createProduct(104, "Chocolate", BigDecimal.valueOf(1.99), Rating.FIVE_STAR, LocalDate.now().plusDays(2));
